...
create_or_update_contest_str = "insert into contests (site_id, name, date, num_games, min_cash_score, start_time, entry_fee, places_paid, max_entrants, total_entrants, min_cash_payout, prize_pool, winning_score, slate, bulk, max_entries) \
 ...
 on conflict (site_id, name, date) do update \
                        set num_games = excluded.num_games, min_cash_score = excluded.min_cash_score, start_time = excluded.start_time, \
                            ...
                            bulk = excluded.bulk, max_entries = excluded.max_entries;"
...
def create_or_update_contest(site_id, name, date, bulk=None, num_games=None, min_cash_score=None, start_time=None, entry_fee=None, places_paid=None, max_entrants=None, total_entrants=None, min_cash_payout=None, prize_pool=None, winning_score=None, slate=None, max_entries=None):
    cursor.execute(create_or_update_contest_str, (site_id, name, date, num_games, min_cash_score, start_time, entry_fee, places_paid, max_entrants, total_entrants, min_cash_payout, prize_pool, winning_score, slate, json.dumps(bulk), max_entries,))
    return conn.commit()
