...
# def create_or_update_projection(stat_line_id, source, bulk, minutes, dk_points, fd_points, version=None):
#     cursor.execute(create_or_update_projection_str, (stat_line_id, source, json.dumps(bulk), minutes, dk_points, fd_points, version,))
#     return conn.commit()
