...
create_stat_line_str = "insert into stat_lines(player_id, team_id, game_id, dk_points, fd_points, stats, minutes) \
...
def create_stat_line_with_stats(player_id, team_id, game_id, dk_points, fd_points, stats, minutes):
    cursor.execute(create_stat_line_str, (player_id, team_id, game_id, dk_points, fd_points, json.dumps(stats), minutes,))
    return conn.commit()